...
export async function getFeatureFlags(
  ...
  const { data } = await supabase
    .from('app_settings')
    .select('key, value')
    .in('key', ['feature_calendar', 'feature_checkin', 'feature_blast', 'feature_rehearsals', 'feature_auditions', 'feature_inventory', 'feature_forums', 'feature_messages', 'feature_beta'])
  ...
  return {
    ...
    forums: map['feature_forums'] !== 'false',
    messages: map['feature_messages'] !== 'false',
    beta: map['feature_beta'] !== 'false',
  }
}
