...
export default async function SetupPage() {
  ...
  const initialValues: SetupPanelInitialValues = {
    ...
    org_timezone: settingsMap.get('org_timezone') || 'America/Chicago',
    ...
    feature_auditions: settingsMap.get('feature_auditions') || 'true',
    feature_inventory: settingsMap.get('feature_inventory') || 'true',
    feature_forums: settingsMap.get('feature_forums') || 'true',
    feature_messages: settingsMap.get('feature_messages') || 'false',
    feature_beta: settingsMap.get('feature_beta') || 'false',
