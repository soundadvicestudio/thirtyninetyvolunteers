  ...
  return (
    <div className="rounded-xl border border-divider bg-white p-6 shadow-sm">
      <div className="flex items-start justify-between gap-3 flex-wrap mb-2">
        <h2 className="text-brand-primary font-bold text-xl">{show.name}</h2>
        <span
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="w-full bg-brand-primary-light py-10 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <h1 className="text-brand-primary font-bold text-2xl md:text-3xl">Volunteer Opportunities</h1>
          ...
          {flags.calendar && (
            <Link href="/calendar" className="inline-block text-sm text-brand-primary hover:underline mt-4">
              📅 View Calendar →
            </Link>
          )}
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          {shows.length === 0 ? (
            <div className="text-center py-12">
              ...
              <Link href="/" className="text-brand-primary font-semibold underline">
                ← Back to Home
              </Link>
            </div>
          ) : (
