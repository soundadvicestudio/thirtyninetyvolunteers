...
export default function PostShowReport({ data }: { data: PostShowReportData }) {
  ...
  return (
    <div className="space-y-8">
      ...
      {attendanceNotMarked && (
        <p className="text-sm text-mid-gray dark:text-dark-muted bg-gray-50/30 dark:bg-dark-bg/40 border border-divider dark:border-dark-border rounded-lg px-4 py-3">
