...
export default function CalendarEventChip({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`w-full text-left rounded-lg border-l-4 bg-white dark:bg-dark-surface px-3 py-2 hover:bg-gray-50 dark:hover:bg-dark-bg/40 transition-colors cursor-pointer ${
